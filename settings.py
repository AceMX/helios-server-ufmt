...
ALLOWED_HOSTS = get_from_env("ALLOWED_HOSTS", "evotacao.ufmt.br").split(",")
...
DEFAULT_FROM_EMAIL = get_from_env("DEFAULT_FROM_EMAIL", "eleicao@ufmt.br")
DEFAULT_FROM_NAME = get_from_env(
    "DEFAULT_FROM_NAME", "Sistema de Votação Eletrônica UFMT"
)
...
URL_HOST = get_from_env("URL_HOST", "https://evotacao.ufmt.br").rstrip("/")
...
# election stuff
SITE_TITLE = get_from_env("SITE_TITLE", _("Sistema e-Votação UFMT"))
...
WELCOME_MESSAGE = get_from_env(
    "WELCOME_MESSAGE", _("Bem vindo ao Sistema e-Votação UFMT")
)

HELP_EMAIL_ADDRESS = get_from_env("HELP_EMAIL_ADDRESS", "ces@ufmt.br")
...
# email server
EMAIL_HOST = get_from_env("EMAIL_HOST", "smtp8.ufmt.br")
EMAIL_PORT = int(get_from_env("EMAIL_PORT", "25"))
EMAIL_HOST_USER = get_from_env("EMAIL_HOST_USER", "eleicao")
...
AUTH_LDAP_SERVER_URI = "ldap://192.168.109.167:389"  # replace by your Ldap URI
AUTH_LDAP_BIND_DN = "cn=leitor-sei,dc=sei-ldap,dc=ufmt,dc=br"
AUTH_LDAP_BIND_PASSWORD = ""
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    "dc=sei-ldap,dc=ufmt,dc=br", ldap.SCOPE_SUBTREE, "(uid=%(user)s)"
)
